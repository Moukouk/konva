...
// Supports verticaux : distance tige -> point SL/SR
...
// petite patte horizontale au point de fixation
...
// Cote verticale tige -> point support
...
function updateSummary() {
  ...
  summary.supportArm.textContent =
    `Distance tige → point SL/SR : ${state.supportArmLength} cm`;
...
function draw() {
  ...
  windowWidthLine.points([0, windowHeightPx + 36, windowWidthPx, windowHeightPx + 36]);
  windowWidthLeftMarker.points([0, windowHeightPx + 26, 0, windowHeightPx + 46]);
  windowWidthRightMarker.points([windowWidthPx, windowHeightPx + 26, windowWidthPx, windowHeightPx + 46]);
  ...
  // Mesures extrémité -> supports
  supportLeftMeasureLine.points([0, 94, leftSupportX, 94]);
  supportLeftMeasureMarkerA.points([0, 86, 0, 102]);
  supportLeftMeasureMarkerB.points([leftSupportX, 86, leftSupportX, 102]);
  ...
  supportRightMeasureLine.points([rightSupportX, 94, rodWidthPx, 94]);
  supportRightMeasureMarkerA.points([rightSupportX, 86, rightSupportX, 102]);
  ...
  supportSpanMeasureLine.points([leftSupportX, 126, rightSupportX, 126]);
  supportSpanMeasureMarkerA.points([leftSupportX, 118, leftSupportX, 134]);
  supportSpanMeasureMarkerB.points([rightSupportX, 118, rightSupportX, 134]);
  ...
  // Distance verticale tige -> SL/SR
  const verticalMeasureX = leftSupportX - 34;
